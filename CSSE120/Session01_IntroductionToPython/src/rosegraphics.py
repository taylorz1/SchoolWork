...
class TurtleWindow(object):
    ...
    def close_on_mouse_click(self):
        ...
        # I need the following statement in case we open a subsequent
        # TurtleWindow during this run.  The  turtle  library seems
        # not to allow for that possibility (it uses a CLASS variable
        # _RUNNING where I would have expected an INSTANCE variable).
        # AFAIK, the following does no harm.
