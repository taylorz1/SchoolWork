...
#
#       -- EXAMPLE files are named with an 'e', like this:
...
#      -- You can RE-commit a changed file, no problem.
#      -- A black dot beside the filename means that you have made
...
#
# Throughout,  ** ASK QUESTIONS **  as needed.
#
