...
#            Main calls a set of functions to see if they work.
#
...
#            Creates a turtle. Moves the turtle from inputs to inputs.
#
#     c. Read the green DOC-STRINGs of the   draw_many_squares
#        function below.  Summarize here, in 10 words or fewer,
#        what does  DRAW_MANY_SQUARES  do?
#            This functions draws as many squares as perscribed and described in its inputs.
#
#     d. Read the green DOC-STRINGs of the   turtle3
#        function below.  Summarize here, in 10 words or fewer,
#        what does  TURTLE3  do?
#            Turtle3 draws the pole shape.
#
...
def try_methods_and_functions():
    ...
    #
    ####################################################################
    peach = rg.SimpleTurtle()
    peach.pen = rg.Pen('blue', 5)
    peach.backward(150)
    peach.speed = 1
    draw_many_squares(peach, 2, 100, 30)
    peach.speed = 5
    peach.pen.color = 'red'
    draw_many_squares(peach, 10, 50, 15)
    peach.speed = 100
    peach.pen.thickness = 35
    draw_many_squares(peach, 8, 300, 60)
    peach.pen = rg.Pen('black', 3)
    peach.backward(200)
    peach.draw_circle(30)
    peach.draw_square(50)
