...
def test_even_better_draw_circles():
    ...
    print('--------------------------------------------------')
    even_better_draw_circles(3, 9, 'green')
    even_better_draw_circles(2, 10, 'red')
    even_better_draw_circles(10, 5, 'blue')


def even_better_draw_circles(r, number_circles, color):


    window = rg.RoseWindow(400, 400)

    center = rg.Point(200, 200)
    for k in range(number_circles + 1):
        circle = rg.Circle(center, r * k)
