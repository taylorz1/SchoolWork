...
Authors: David Mutchler, Valerie Galluzzi, Mark Hays, Amanda Stouder,
         their colleagues and Zachary Taylor.  December 2015.
...
def problem0a(n):
    """
    What comes in:  An integer.
    What goes out:  True if the sum of the digits in the given integer
                    is odd, else False.
    Side effects:   None.
    Examples:
...
def problem0b(n):
    """
    What comes in:  An integer n >= 2.
    What goes out:  The number of integers from 2 to n, inclusive,
                    that are prime.
    Side effects:   None.
    Examples:
