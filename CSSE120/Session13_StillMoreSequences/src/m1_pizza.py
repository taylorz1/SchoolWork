...
def test_generate_points_on_circle():
    ...
    # ------------------------------------------------------------------
    expected = [rg.Point(120.0, 50.0),  # All numbers are approximate.
                rg.Point(110.0, 67.3),
                rg.Point(90.0, 67.3),
                rg.Point(80.0, 50.0),
                rg.Point(90.0, 32.7),
...
def test_draw_points_on_circle():
    ...
    # ------------------------------------------------------------------
    title = 'DRAW_POINTS_ON_CIRCLE, test 4:  5 yellow dots.'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(200, 200), 150)
...
def test_pizza():
    ...
    # ------------------------------------------------------------------
    title = 'PIZZA test 1:  6 slices, thin (thickness=3) blue lines.'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(200, 200), 150)
    circle.outline_thickness = 3
    pizza(window, circle, 6, 'blue', 3)
    window.close_on_mouse_click()
...
def test_polygon():
    ...
    circle = rg.Circle(rg.Point(100, 100), 80)
    circle.outline_thickness = 3
    polygon(window, circle, 7, 'blue', 10)
    window.close_on_mouse_click()
...
def test_fancy_polygon():
    ...
    circle = rg.Circle(rg.Point(240, 165), 150)
    circle.fill_color = 'blue'
    fancy_polygon(window, circle, 20, 3, 'black', 5)
    window.close_on_mouse_click()
