...
def main():
    ...
    if p1_test.is_implemented('change_to_next_color'):
        test_change_to_next_color()
...
class CircleChanger(object):
    ...
    def __init__(self, x, y, radius, fill_color, colors):
        ...
        What comes in:
          ...
          -- A non-empty tuple of strings that represent colors in RoseGraphics
        ...
        self.seconds_to_sleep = 0.05  # Default for each call to draw
    ...
    def swell_or_shrink_once(self, amount_to_swell_or_shrink):
        ...
        n = random.randrange(3, 16)
        self.circle.outline_thickness = n
        l = random.randrange(0, len(self.colors))
        self.circle.fill_color = self.colors[l]
    ...
    def swell_or_shrink_repeatedly(self,
        ...
        Side effects:
          Does the following 4 steps repeatedly:
            1. This CircleChanger's circle swells/shrinks by the
                 given amount_to_swell_or_shrink.
            2. This CircleChanger is drawn
                 (by using its  draw   method with no arguments).
            3. This CircleChanger's circle swells/shrinks
                 to UNDO the swell/shrink that it just did.
            4. This CircleChanger is drawn (by its  draw   method).
    ...
    def swallow(self, other_circle_changer):
        ...
        #   Third, implement and test this method.
        #
        # *** YOU   ** MUST **   USE the relevant methods
        #   of the    rg.Point     class to compute
        ...
        radius = center.distance_from(other_circle_changer.circle.center)
        c = self.colors + other_circle_changer.colors
        print(center, radius, c)
        return CircleChanger(center.x, center.y, radius, 'red', c)
    ...
    def change_color(self, index_of_color):
        ...
        #   Third, implement and test this method.
        # --------------------------------------------------------------
        self.previous_color = self.circle.fill_color
    ...
    def change_to_previous_color(self):
        ...
        Example:
          Suppose that the CircleChanger's circle has fill_color
          'blue' at some point in time.  Suppose that
              change_color('green')
           was called on this CircleChanger at that point in time,
           so that this CircleChanger's circle now has fill_color
        ...
        #   (below).  Third, implement and test this method.
        # --------------------------------------------------------------
        self.circle.fill_color = self.previous_color
...
def test_change_to_next_color():
    """ Tests the   change_to_next_color   method. """
#     p1_test.change_to_next_color()  # This runs OUR tests.
    ...
    for _ in range(16):
        circle_changer1.change_to_next_color()
        circle_changer1.draw(0.25)

        circle_changer2.change_to_next_color()
