...
public class DiscountMain {
	...
	public static String getTotalDiscountString(String name, double price) {
		ItemDiscount[] fixedDiscounts = new FixedDiscount[3];
		ItemDiscount[] percentageDiscounts = new PercentageDiscount[2];
		...
		double discounts1 = calculateDiscounts(name, price, fixedDiscounts);
		double discounts2 = calculateDiscounts(name, price, percentageDiscounts);
	...
	private static double calculateDiscounts(String name, double price, ItemDiscount[] discounts) {
		double total = 0;
