...
public class SinglyLinkedList {
	...
	public static int indexOfFirstDifference(SinglyLinkedList one, SinglyLinkedList two) {
		...
		// TODO: Write this
		Node currentL1 = one.first;
		Node currentL2 = two.first;
		int index = 0;
		...
		if ((currentL1 == null && currentL2 != null) || (currentL2 == null && currentL1 != null)) {
			//Not sure how to make an exclusive or.
			return index;
		}
		return -1;
	}
