...
public class TwelveProblems {
	...
	public static int[] powersOfTwo(int maxExponent) {
		...
		int[] w = new int[maxExponent + 1];
		for (int i = 0; i < maxExponent + 1; i++) {
			w[i] = (int) Math.pow((double) 2, (double) i);
		}
		return w;
	}
