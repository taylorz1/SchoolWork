 ...
 * 
 *  DONE
 * @author Claude Anderson and Zachary Taylor. Created Oct 12, 2011.
 */
public class AdderMain {
	...
	private static long buttonvalue = 0;
	...
	public static void main(String[] args) {
		...
		class NumberListener implements ActionListener {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (g.equals("C")) {
					...
					displayed = Integer.toString((int) currentvalue) + b.getText();
					currentvalue = Integer.valueOf(displayed);
				}
			}
		}
		...
		while(true) {
			display.setText(Integer.toString((int) currentvalue));
		}
	}
}
